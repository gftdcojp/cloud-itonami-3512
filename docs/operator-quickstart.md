# Operator Quickstart — Community Renewable Energy Operations

Shortest path from clone to a verified local dry-run for **ISIC 3512** (`cloud-itonami-isic-3512`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-3512.git
cd cloud-itonami-isic-3512
```
...
- Blueprint governor key: `grid-policy-governor`
- Likely source path: `energy.governor.cljc`
